...
async function comprehensiveExample() {
    ...
    console.log(`Funded balance: ${balanceQuery.account.balance} ACME tokens\n`);
    ...
    console.log(`Credits balance: ${creditsQuery.account?.creditBalance || 0} credits\n`);
    ...
    console.log(`Identity type: ${identityQuery.account.type}`);
    ...
    for (let i = 0; i < 10; i++) {
        try {
            ...
            const credits = keyPageCreditsQuery.data?.creditBalance || 0;
    ...
    console.log(`Data account type: ${dataAccountQuery.account.type}\n`);
...
//# sourceMappingURL=comprehensive_api_v3.js.map