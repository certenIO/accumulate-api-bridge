...
async function liteIdentitySetupExample() {
    ...
    while (attempts < maxAttempts) {
        try {
            ...
            const balance = balanceQuery.account.balance || 0;
    ...
    const finalBalance = balanceQuery.account.balance;
    ...
    const finalCredits = creditsQuery.account?.creditBalance || 0;
...
//# sourceMappingURL=lite_identity_setup.js.map