...
import { api_v2, BaseKey, ED25519Key, PrivateKeyAddress, Signer, URL, } from "accumulate.js";
...
class EthKey extends BaseKey {
    ...
    async signRaw(signature, message) {
        ...
        const r = ecdsaSignature.r.toString(16).padStart(64, '0');
        const s = ecdsaSignature.s.toString(16).padStart(64, '0');
        const recoveryId = ecdsaSignature.recovery;
...
async function main() {
    ...
    const ethKey = PrivateKeyAddress.from(SignatureType.ETH, publicKey, key.privateKey);
...
//# sourceMappingURL=ethkey.js.map