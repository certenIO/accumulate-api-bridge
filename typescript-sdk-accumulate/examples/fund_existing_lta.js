...
async function fundExistingLtaExample() {
    ...
    try {
        ...
        initialBalance = initialQuery.account.balance || 0;
    ...
    while (attempts < maxAttempts) {
        try {
            ...
            currentBalance = balanceQuery.account.balance || 0;
    ...
    try {
        ...
        const availableBalance = finalBalanceQuery.account.balance || 0;
...
//# sourceMappingURL=fund_existing_lta.js.map